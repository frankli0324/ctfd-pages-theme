...
function getJSConfig(root, type, entries, mode) {
  ...
  return {
      ...
      rules: [
        {
          ...
          use: {
            ...
            options: {
              cacheDirectory: true,
              presets: [
                ['@babel/preset-env', { useBuiltIns: 'entry', modules: 'commonjs', targets: { esmodules: true }}],
              ],
            }
          }
        },
    ...
    resolve: {
      extensions: ['.js'],
      alias: {
        core: path.resolve(__dirname, 'CTFd/themes/pages/assets/js/'),
      },
    },
  }
}
...
function getCSSConfig(root, type, entries, mode) {
  ...
  return {
    ...
    resolve: {
      extensions: ['.css'],
      alias: {
        core: path.resolve(__dirname, 'CTFd/themes/pages/assets/css/'),
      },
    },
    plugins: [
